...
@section('content')
    ...
    @component('common-components.breadcrumb')
        ...
        @slot('li_1') Customize and accept payments for the loan installments. @endslot
    @endcomponent
    ...
    <div class="row">
        <div class="col-lg-4">
                ...
                <table class="table table-bordered table-condensed table-striped">
                    ...
                    <tr>
                        ...
                        <td class="text-right text-danger" data-fill="due_amount" style="font-weight: bold">
                            Rs. {{ number_format($loanTotal - $totalPaid, 2) }}
                        </td>
                    </tr>
                    </tbody>
                </table>
            ...
            {{-- TODO: Following block should only be displayed if the permissions are there for the logged in user.
             TODO: To be implemented after the lara trust implementation to the user module. --}}
            {{--            <div class="card">--}}
        ...
        <div class="col-lg-8">
            ...
            @if(($loan->scheme->type == \App\Enums\SchemeType::MONTHLY) || ($loan->scheme->type == \App\Enums\SchemeType::CUSTOM))
                <div class="card border border-primary">
                    <div class="card-header bg-primary text-white">
                        Add Payment
                    </div>
                    <div class="card-body">
                        <form action="{{ route('customer-loans.payments.monthly.create', $loan->id) }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="payment_date" name="payment_date" class="form-control" readonly required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="installment_amount" name="installment_amount" class="form-control" placeholder="0.00" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <label for="">&nbsp;</label>
                                    <button type="submit" id="send_payment" name="send_payment" class="btn btn-primary btn-block">Make Payment</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="#" method="post" class="form-horizontal d-none" id="add_installment_form">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date mb-3">
                                        <input type="text" class="form-control" placeholder="Click to Select"
                                               aria-label="Installment Date" aria-describedby="basic-addon2"
                                               id="installment_date" name="installment_date" required readonly>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-block">
                                        <span class="fa fa-plus"></span> Add Installment
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <table class="table table-striped table-condensed mt-2" id="installments_table">
                        ...
                        @forelse($installments as $installment)
                            ...
                            <tr>
                                ...
                                <td class="text-right text-danger">{{ number_format(abs($installment->arrears_amount), 2) }}</td>
