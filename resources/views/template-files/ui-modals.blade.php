                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            <div class="my-4 text-center">
                                ...
                                <button type="button" class="btn btn-primary waves-effect waves-light"
                                        data-toggle="modal" data-target="#myModal">Standard modal
                                </button>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            <div class="my-4 text-center">
                                ...
                                <!-- Extra Large modal -->
                                <button type="button" class="btn btn-primary waves-effect waves-light"
                                        data-toggle="modal" data-target=".bs-example-modal-xl">Extra large modal
                                </button>
                            </div>
                            ...
                            <div class="modal fade bs-example-modal-xl" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title mt-0" id="myExtraLargeModalLabel">Extra large
                                                modal</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            <div class="my-4 text-center">
                                ...
                                <!-- Large modal -->
                                <button type="button" class="btn btn-primary waves-effect waves-light"
                                        data-toggle="modal" data-target=".bs-example-modal-lg">Large modal
                                </button>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            <div class="my-4 text-center">
                                ...
                                <!-- Small modal -->
                                <button type="button" class="btn btn-primary waves-effect waves-light"
                                        data-toggle="modal" data-target=".bs-example-modal-sm">Small modal
                                </button>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            <div class="my-4 text-center">
                                ...
                                <!-- Small modal -->
                                <button type="button" class="btn btn-primary waves-effect waves-light"
                                        data-toggle="modal" data-target=".bs-example-modal-center">Center modal
                                </button>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            <div class="my-4 text-center">
                                ...
                                <!-- Small modal -->
                                <button type="button" class="btn btn-primary waves-effect waves-light"
                                        data-toggle="modal" data-target="#exampleModalScrollable">Scrollable modal
                                </button>
                            </div>
                            ...
                            <div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-scrollable">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title mt-0" id="exampleModalScrollableTitle">Scrollable
                                                Modal</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
