                        ...
                        <ul class="verti-timeline list-unstyled">
                            <li class="event-list active">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div>
                                            <h5 class="font-size-15"><a href="#" class="text-dark">Back end
                                                    Developer</a></h5>
                            ...
                            <li class="event-list">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div>
                                            <h5 class="font-size-15"><a href="#" class="text-dark">Front end
                                                    Developer</a></h5>
                            ...
                            <li class="event-list">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div>
                                            <h5 class="font-size-15"><a href="#" class="text-dark">UI /UX Designer</a>
                                            </h5>
