                    ...
                    <div id="upcoming-task" class="pb-1 task-list">
                        <div class="card task-box">
                            <div class="card-body">
                                ...
                                <div>
                                    <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark">Topnav
                                            layout design</a></h5>
                        ...
                        <div class="card task-box">
                            <div class="card-body">
                                ...
                                <div>
                                    <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark">Create a
                                            New Landing UI</a></h5>
                        ...
                        <div class="text-center">
                            <a href="javascript: void(0);"
                               class="btn btn-primary btn-block mt-1 waves-effect waves-light"><i
                    ...
                    <div id="inprogress-task" class="pb-1 task-list">
                        <div class="card task-box">
                            <div class="card-body">
                                ...
                                <div>
                                    <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark">Brand logo
                                            design</a></h5>
                        ...
                        <div class="card task-box">
                            <div class="card-body">
                                ...
                                <div>
                                    <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark">Skote
                                            Dashboard UI</a></h5>
                                    <p class="text-muted mb-4">13 Oct, 2019</p>
                                </div>
                    ...
                    <div id="complete-task" class="pb-1 task-list">
                        <div class="card task-box">
                            <div class="card-body">
                                ...
                                <div>
                                    <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark">Redesign -
                                            Landing page</a></h5>
                        ...
                        <div class="card task-box">
                            <div class="card-body">
                                ...
                                <div>
                                    <h5 class="font-size-15"><a href="javascript: void(0);" class="text-dark">Multipurpose
                                            Landing</a></h5>
