                    ...
                    <div class="media">
                        ...
                        <div class="dropdown">
                            <button type="button" class="btn btn-light dropdown-toggle" data-toggle="dropdown"
                                    ...
                                    class="d-none d-sm-inline-block">Wallet Balance <i class="mdi mdi-chevron-down"></i></span>
                            </button>
                        ...
                        <div class="col-xl-3 col-sm-4">
                            <div class="media">
                                <div class="avatar-sm mr-3">
                                                        <span
                                                            class="avatar-title rounded-circle bg-soft-warning text-warning font-size-22">
                            ...
                            <div class="tab-pane" id="exchange-tab" role="tabpanel">
                                <div class="float-right ml-2">
                                    <h5 class="font-size-14"><i
                                            class="bx bx-wallet text-primary font-size-16 align-middle mr-1"></i>
                                        $4235.23</h5>
                                </div>
