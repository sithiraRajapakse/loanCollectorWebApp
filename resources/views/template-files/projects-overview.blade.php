            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-muted mt-4">
                        <p><i class="mdi mdi-chevron-right text-primary mr-1"></i> To achieve this, it would be
                            necessary</p>
                    ...
                    <div class="row task-dates">
                        <div class="col-lg-4">
                            <div class="mt-4">
                                <h5 class="font-size-14"><i class="bx bx-calendar mr-1 text-primary"></i> Start Date
                                </h5>
                    ...
                    <div class="table-responsive">
                        <table class="table table-centered">
                            ...
                            <tr>
                                ...
                                <td><h5 class="font-size-14 m-0"><a href="" class="text-dark">Daniel Canales</a></h5>
                                </td>
                                <td>
                                    <div>
                            ...
                            <tr>
                                ...
                                <td><h5 class="font-size-14 m-0"><a href="" class="text-dark">Jennifer Walker</a></h5>
                                </td>
                                <td>
                                    <div>
                            ...
                            <tr>
                                ...
                                <td><h5 class="font-size-14 m-0"><a href="" class="text-dark">Tony Brafford</a></h5>
                                </td>
                                <td>
                                    <div>
                                        <a href="#" class="badge badge-primary font-size-11">Backend</a>
