                                ...
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item mr-3">
                                        <h5 class="font-size-14" data-toggle="tooltip" data-placement="top"
                                            title="Amount"><i class="bx bx-money mr-1 text-primary"></i> $ 1455</h5>
                                    </li>
                        ...
                        <div class="col-lg-8">
                            <div>
                                ...
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item mr-3">
                                        <h5 class="font-size-14" data-toggle="tooltip" data-placement="top"
                                            title="Amount"><i class="bx bx-money mr-1 text-primary"></i> $ 1024</h5>
                                    </li>
                                    <li class="list-inline-item">
                                        <h5 class="font-size-14" data-toggle="tooltip" data-placement="top"
                        ...
                        <div class="col-lg-8">
                            <div>
                                ...
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item mr-3">
                                        <h5 class="font-size-14" data-toggle="tooltip" data-placement="top"
                                            title="Amount"><i class="bx bx-money mr-1 text-primary"></i> $ 1189</h5>
                                    </li>
                                    <li class="list-inline-item">
                                        <h5 class="font-size-14" data-toggle="tooltip" data-placement="top"
                        ...
                        <div class="col-lg-8">
                            <div>
                                ...
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item mr-3">
                                        <h5 class="font-size-14" data-toggle="tooltip" data-placement="top"
                                            title="Amount"><i class="bx bx-money mr-1 text-primary"></i> $ 1245</h5>
                                    </li>
                                    <li class="list-inline-item">
                                        <h5 class="font-size-14" data-toggle="tooltip" data-placement="top"
                                            title="Due Date"><i class="bx bx-calendar mr-1 text-primary"></i> 12 Oct, 19
                        ...
                        <div class="col-lg-8">
                            <div>
                                ...
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item mr-3">
                                        <h5 class="font-size-14" data-toggle="tooltip" data-placement="top"
                                            title="Amount"><i class="bx bx-money mr-1 text-primary"></i> $ 1148</h5>
                                    </li>
                                    <li class="list-inline-item">
                                        <h5 class="font-size-14" data-toggle="tooltip" data-placement="top"
                        ...
                        <div class="col-lg-8">
                            <div>
                                ...
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item mr-3">
                                        <h5 class="font-size-14" data-toggle="tooltip" data-placement="top"
                                            title="Amount"><i class="bx bx-money mr-1 text-primary"></i> $ 1259</h5>
                                    </li>
                                    <li class="list-inline-item">
                                        <h5 class="font-size-14" data-toggle="tooltip" data-placement="top"
                        ...
                        <div class="col-lg-8">
                            <div>
                                ...
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item mr-3">
                                        <h5 class="font-size-14" data-toggle="tooltip" data-placement="top"
                                            title="Amount"><i class="bx bx-money mr-1 text-primary"></i> $ 1355</h5>
                                    </li>
                                    <li class="list-inline-item">
                                        <h5 class="font-size-14" data-toggle="tooltip" data-placement="top"
                                            title="Due Date"><i class="bx bx-calendar mr-1 text-primary"></i> 15 Oct, 19
