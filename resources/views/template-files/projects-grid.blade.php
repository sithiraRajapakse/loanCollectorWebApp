                ...
                <div class="card-body">
                    <div class="media">
                        ...
                        <div class="media-body overflow-hidden">
                            <h5 class="text-truncate font-size-15"><a href="#" class="text-dark">New admin Design</a>
                            </h5>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="media">
                        ...
                        <div class="media-body overflow-hidden">
                            <h5 class="text-truncate font-size-15"><a href="#" class="text-dark">Brand logo design</a>
                            </h5>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="media">
                        ...
                        <div class="media-body overflow-hidden">
                            <h5 class="text-truncate font-size-15"><a href="#" class="text-dark">New Landing Design</a>
                            </h5>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="media">
                        ...
                        <div class="media-body overflow-hidden">
                            <h5 class="text-truncate font-size-15"><a href="#" class="text-dark">Redesign - Landing
                                    page</a></h5>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="media">
                        ...
                        <div class="media-body overflow-hidden">
                            <h5 class="text-truncate font-size-15"><a href="#" class="text-dark">Skote Dashboard UI</a>
                            </h5>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="media">
                        ...
                        <div class="media-body overflow-hidden">
                            <h5 class="text-truncate font-size-15"><a href="#" class="text-dark">Blog Template UI</a>
                            </h5>
                            <p class="text-muted mb-4"> For science, music, sport, etc</p>
                            <div class="team">
                                <a href="javascript: void(0);" class="team-member d-inline-block" data-toggle="tooltip"
            ...
            <div class="card">
                <div class="card-body">
                    <div class="media">
                        ...
                        <div class="media-body overflow-hidden">
                            <h5 class="text-truncate font-size-15"><a href="#" class="text-dark">Multipurpose
                                    Landing</a></h5>
                            <p class="text-muted mb-4">It will be as simple as Occidental</p>
                            <div class="team">
                                <a href="javascript: void(0);" class="team-member d-inline-block" data-toggle="tooltip"
                            ...
                            <div class="team">
                                <div class="team">
                                    <a href="javascript: void(0);" class="team-member d-inline-block"
                                       ...
                                       data-original-title="Derek Mathes">
                                        <div class="avatar-xs m-1">
                                                                <span
                                                                    class="avatar-title rounded-circle bg-soft-primary text-primary font-size-16">
                                                                    D
                                    ...
                                    <a href="javascript: void(0);" class="team-member d-inline-block"
                                       data-toggle="tooltip" data-placement="top" title=""
                                       data-original-title="Harold Mendez">
                                        <div class="avatar-xs m-1">
                                                                <span
                                                                    class="avatar-title rounded-circle bg-soft-primary text-primary font-size-16">
                                                                    H
                                    ...
                                    <a href="javascript: void(0);" class="team-member d-inline-block"
                                       data-toggle="tooltip" data-placement="top" title=""
                                       data-original-title="Patricia Harrison">
                                        <img src="assets/images/users/avatar-4.jpg" class="rounded-circle avatar-xs m-1"
                                             alt="">
                                    </a>
                                </div>
