                            ...
                            <div class="media-body">
                                ...
                                <div class="media mt-4">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="text-muted font-size-12"><i
                                                class="far fa-calendar-alt text-primary mr-1"></i> 08 Oct, 2019
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        <div class="text-center text-md-left pt-3 pt-md-0">
                                            ...
                                            <h5 class="my-0"><span class="text-muted mr-2"><del>$240</del></span> <b>$225</b>
                                            </h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        <div class="text-center text-md-left pt-3 pt-md-0">
                                            ...
                                            <h5 class="my-0"><span class="text-muted mr-2"><del>$150</del></span> <b>$145</b>
                                            </h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        <div class="text-center text-md-left pt-3 pt-md-0">
                                            ...
                                            <h5 class="my-0"><span class="text-muted mr-2"><del>$138</del></span> <b>$135</b>
                                            </h5>
                                        </div>
                                    </div>
                                </div>
