                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-right">
                                <button type="button"
                                        ...
                                        class="mdi mdi-plus mr-1"></i> New Customers
                                </button>
                            </div>
                        </div><!-- end col-->
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-centered table-nowrap">
                            ...
                            <tr>
                                ...
                                <td><span class="badge badge-success font-size-12"><i class="mdi mdi-star mr-1"></i> 4.2</span>
                                </td>
                                <td>$5,412</td>
                                <td>07 Oct, 2019</td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="#" class="dropdown-item"><i
                                                        class="mdi mdi-pencil font-size-16 text-success mr-1"></i> Edit</a>
                                            </li>
                                            <li><a href="#" class="dropdown-item"><i
                            ...
                            <tr>
                                ...
                                <td><span class="badge badge-success font-size-12"><i class="mdi mdi-star mr-1"></i> 4.0</span>
                                </td>
                                <td>$5,632</td>
                                <td>06 Oct, 2019</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><span class="badge badge-success font-size-12"><i class="mdi mdi-star mr-1"></i> 4.4</span>
                                </td>
                                <td>$7,523</td>
                                <td>06 Oct, 2019</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><span class="badge badge-success font-size-12"><i class="mdi mdi-star mr-1"></i> 4.1</span>
                                </td>
                                <td>$6,325</td>
                                <td>05 Oct, 2019</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><span class="badge badge-success font-size-12"><i class="mdi mdi-star mr-1"></i> 3.8</span>
                                </td>
                                <td>$4,523</td>
                                <td>04 Oct, 2019</td>
                                <td>
