                        ...
                        <div class="col-lg-9 col-sm-8">
                            <div class="p-4">
                                ...
                                <div class="text-muted">
                                    <p class="mb-1"><i class="mdi mdi-circle-medium align-middle text-primary mr-1"></i>
                                        If several languages coalesce</p>
                                    <p class="mb-1"><i class="mdi mdi-circle-medium align-middle text-primary mr-1"></i>
                                        Sed ut perspiciatis unde</p>
                                    <p class="mb-0"><i class="mdi mdi-circle-medium align-middle text-primary mr-1"></i>
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-4 col-sm-6 align-self-center">
                            <div>
                                <p class="mb-2"><i
                                        class="mdi mdi-circle align-middle font-size-10 mr-2 text-primary"></i> Ethereum
                                </p>
                            ...
                            <div class="mt-4 pt-2">
                                <p class="mb-2"><i
                                        class="mdi mdi-circle align-middle font-size-10 mr-2 text-warning"></i> Bitcoin
                                </p>
